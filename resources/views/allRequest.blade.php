            ...
            <div class="panel panel-default">
                    ...
                    <div class="modal fade" id="edit" tabindex="1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content" style="height:900px; width:700px; position:center">
                            ...
                            <form  method="post" action="{{url('/getReview')}}">
                                {{ csrf_field() }}
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <img  id="ccp"  src="{{url("companyphoto")}}" style="width:40px; height:40px; border-radius:50%">  <input disabled="disabled" name="companyname" id="ccn"  cols="10" rows="1" class="form-">
